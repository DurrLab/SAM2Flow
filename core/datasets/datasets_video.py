...
class FlyingThings3D(FlowDataset):
    def __init__(self, aug_params=None, input_frames=5, root='datasets/FlyingThings3D/', dstype='frames_cleanpass', forward_warp=False):
        ...
        self.flow_list = []
        self.has_gt_list = []
        with open("/home/durrlab/Desktop/OpticalFlow/MemFlow/flow_dataset_mf/flyingthings_" + dstype + "_png.pkl", "rb") as f:
            _image_list = pickle.load(f)
        with open("/home/durrlab/Desktop/OpticalFlow/MemFlow/flow_dataset_mf/flyingthings_" + dstype + "_future_pfm.pkl", "rb") as f:
            _future_flow_list = pickle.load(f)
        with open("/home/durrlab/Desktop/OpticalFlow/MemFlow/flow_dataset_mf/flyingthings_" + dstype + "_past_pfm.pkl", "rb") as f:
